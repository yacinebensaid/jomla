...
class _CartCardState extends State<CartCard> {
                        ...
                        children: [
                          ...
                          Text.rich(
                            TextSpan(
                              ...
                              children: [
                                TextSpan(
                                    text: " ${widget.product.total_quantity}",
                                    style: TextStyle(
                ...
                return Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      Text(
                        '${widget.product.variations![index]['quantity']}',
  ...
  Widget SizeOnlyCartWidget({required productSnapshot}) {
  ...
  Widget ColorAndSizeCartWidget({required productSnapshot}) {
    return Container(
      decoration: BoxDecoration(
        borderRadius: BorderRadius.circular(12),
        color: Colors.white,
