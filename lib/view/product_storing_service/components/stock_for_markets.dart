...
class StockMarkets extends StatefulWidget {
  const StockMarkets({Key? key}) : super(key: key);

  @override
  State<StockMarkets> createState() => _StockMarketsState();
}

int _totalPrice = 0;
List _checkedProducts = [];

class _StockMarketsState extends State<StockMarkets> {
          ...
          child: Column(
            children: [
              Row(
                children: [
                  ...
                  Container(
                    decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(18),
                        color: Color.fromARGB(255, 8, 110, 11)),
                    child: const Padding(
              ...
              Padding(
                ...
                child: Text(_totalPrice == 0 ? '' : _totalPrice.toString()),
              )
            ],
          ),
        ),
